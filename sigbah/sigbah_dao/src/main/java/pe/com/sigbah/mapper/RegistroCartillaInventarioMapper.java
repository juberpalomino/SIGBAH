 ...
 */
public class RegistroCartillaInventarioMapper implements RowMapper<CartillaInventarioBean> {
	...
	public CartillaInventarioBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		cartillaInventario.setObservacion(rs.getString("OBSERVACION_CARTILLA"));		
