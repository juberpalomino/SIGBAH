 ...
 */
public class DonRegistroCierreStockMapper implements RowMapper<CierreStockBean> {
	...
	public CierreStockBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		cierreStock.setIdResponsable(rs.getInt("FK_IDE_RESPONSABLE_DON"));
		...
		cierreStock.setFecha(rs.getString("FEC_MODIFICA"));
		return cierreStock;
	}
