...
public interface DonacionDao {
	 ...
	 * @throws Exception
	 */
	public abstract List<ProductoDonacionSalidaBean> listarProductoDonacionSalida(ProductoDonacionSalidaBean productoDonacionIngresoBean) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract List<DocumentoSalidaBean> listarDocumentoDonacionSalida(DocumentoSalidaBean documentoDonacionBean) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract DocumentoSalidaBean insertarDocumentoDonacionSalida(DocumentoSalidaBean documentoDonacionBean) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract DocumentoSalidaBean eliminarDocumentoSalidaDonacion(DocumentoSalidaBean documentoDonacionBean) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract DocumentoSalidaBean actualizarDocumentoDonacionSalida(DocumentoSalidaBean documentoDonacionBean) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract List<CartillaInventarioBean> listarCartillaInventario(CartillaInventarioBean cartillaInventarioBean)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract List<ProductoDonacionSalidaBean> listarProductosReporteDonacionSalida(Integer idSalida) throws Exception;
