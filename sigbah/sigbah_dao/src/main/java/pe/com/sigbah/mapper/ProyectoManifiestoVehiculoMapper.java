...
/**
 * @className: ProyectoManifiestoVehiculoMapper.java
 * @description: 
 * @date: 22 de jun. de 2017
 * @author: Junior Huaman Flores.
 */
public class ProyectoManifiestoVehiculoMapper implements RowMapper<ProyectoManifiestoVehiculoBean> {
	
	/* (non-Javadoc)
	 * @see org.springframework.jdbc.core.RowMapper#mapRow(java.sql.ResultSet, int)
	 */
	@Override
	public ProyectoManifiestoVehiculoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		ProyectoManifiestoVehiculoBean proyecto = new ProyectoManifiestoVehiculoBean();
