...
public class ReporteStockAlmacen implements Serializable {
	 ...
	 * @throws Exception 
	 */
	public HSSFWorkbook generaReporteExcelStockAlmacen(List<StockAlmacenBean> lista) throws Exception {
		...
		try {				
	        ...
	        for (StockAlmacenBean calidad : lista) {
		        ...
		        rows.createCell(2).setCellValue(calidad.getNombreCategoria());
		        rows.getCell(2).setCellStyle(style_cell);
		        
		        rows.createCell(3).setCellValue(calidad.getCodigoProducto());
		        rows.getCell(3).setCellStyle(style_cell);
		        
		        rows.createCell(4).setCellValue(calidad.getNombreProducto());
		        rows.getCell(4).setCellStyle(style_cell);
		        
		        rows.createCell(5).setCellValue(calidad.getNombreUnidadMedida());
		        rows.getCell(5).setCellStyle(style_cell);
		        
		        rows.createCell(6).setCellValue(calidad.getNombreEnvase());
		        rows.getCell(6).setCellStyle(style_cell);
		        
		        rows.createCell(7).setCellValue(getString(calidad.getPrecioUnitarioPromedio()));
		        rows.getCell(7).setCellStyle(style_cell);
		        
		        rows.createCell(8).setCellValue(getString(calidad.getCantidad()));
