...
public class ReporteOrdenSalida implements Serializable {
	...
	public void generaPDFReporteSalidas(String ruta, OrdenSalidaBean ordenSalida, List<ProductoSalidaBean> listaProducto, 
		...
		try {
			...
			p = new Paragraph("N° Orden de Compra : ".concat(getString(ordenSalida.getNroOrdenCompra())), normal);
			cell = new PdfPCell(p);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setBorderColor(BaseColor.WHITE);
			...
			p = new Paragraph("Concepto : ".concat(getString(ordenSalida.getConcepto())), normal);
			cell = new PdfPCell(p);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell.setBorderColor(BaseColor.WHITE);
