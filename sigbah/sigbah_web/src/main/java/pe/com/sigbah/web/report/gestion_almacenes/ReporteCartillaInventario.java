...
public class ReporteCartillaInventario implements Serializable {
	...
	public HSSFWorkbook generaReporteExcelCartillaInventario(List<CartillaInventarioBean> lista) throws Exception {
		...
		try {				
	        ...
	        for (CartillaInventarioBean calidad : lista) {
		        ...
		        rows.createCell(2).setCellValue(calidad.getNombreAlmacen());
		        rows.getCell(2).setCellStyle(style_cell);
		        
		        rows.createCell(3).setCellValue(calidad.getNroCartilla());
		        rows.getCell(3).setCellStyle(style_cell);
		        
		        rows.createCell(4).setCellValue(calidad.getFechaCartilla());
		        rows.getCell(4).setCellStyle(style_cell);
		        
		        rows.createCell(5).setCellValue(calidad.getResponsable());
		        rows.getCell(5).setCellStyle(style_cell);
		        
		        rows.createCell(6).setCellValue(getString(calidad.getItemInventariados()));
		        rows.getCell(6).setCellStyle(style_cell);
		        
		        rows.createCell(7).setCellValue(calidad.getNombreEstado());
