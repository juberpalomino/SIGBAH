	...
	public void generaPDFReporteManifiestoCarga(String ruta, List<DetalleManifiestoCargaBean> listaManifiestoCarga) throws Exception {
		...
		try {
			...
			for (DetalleManifiestoCargaBean manifiesto : listaManifiestoCarga) {
				...
				p = new Paragraph(getString(manifiesto.getCantidad()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
				
				p = new Paragraph(getString(manifiesto.getPesoUnitario()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
				
				p = new Paragraph(getString(manifiesto.getPesoTotal()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
				
				p = new Paragraph(getString(manifiesto.getVolumenUnitario()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
				
				p = new Paragraph(getString(manifiesto.getVolumenTotal()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
	...
	public void generaPDFReporteActaEntrega(String ruta, List<DetalleActaEntregaBean> listaActaEntrega) throws Exception {
		...
		try {
			...
			for (DetalleActaEntregaBean acta : listaActaEntrega) {
				...
				p = new Paragraph(getString(acta.getCantidad()), normal);
				cell = new PdfPCell(p);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				table.addCell(cell);
