...
public class ReporteRequerimientoAfectado implements Serializable {
	...
	public HSSFWorkbook generaReporteExcelRequerimientoAfectado(List<EmergenciaBean> lista) throws Exception {
		...
		try {				
	        ...
	        row1.createCell(6).setCellValue("Pob. INEI");
	        row1.getCell(6).setCellStyle(style_header);
	          
	        row1.createCell(7).setCellValue("Fam. Afec.");
	        row1.getCell(7).setCellStyle(style_header);
	        
	        row1.createCell(8).setCellValue("Fam. damnif.");
	        row1.getCell(8).setCellStyle(style_header);
	        
	        row1.createCell(9).setCellValue("Total fam.");
	        row1.getCell(9).setCellStyle(style_header);
	        
	        row1.createCell(10).setCellValue("Pers. afec.");
	        row1.getCell(10).setCellStyle(style_header);
	        
	        row1.createCell(11).setCellValue("Pers. damn.");
	        row1.getCell(11).setCellStyle(style_header);
	        
	        row1.createCell(12).setCellValue("Total Pers.");
	        ...
	        row1.createCell(15).setCellValue("Total fam. REAL");
	        row1.getCell(15).setCellStyle(style_header);
	        
	        row1.createCell(16).setCellValue("Pers. afec. REAL");
	        row1.getCell(16).setCellStyle(style_header);
	        
	        row1.createCell(17).setCellValue("Pers. damn. REAL");
	        row1.getCell(17).setCellStyle(style_header);
	        
	        row1.createCell(18).setCellValue("Total Pers. REAL");
	        ...
	        for (EmergenciaBean emergencia : lista) {
		        ...
		        rows.createCell(2).setCellValue(emergencia.getDesDepartamento());
		        rows.getCell(2).setCellStyle(style_cell);
		        
		        rows.createCell(3).setCellValue(emergencia.getDesProvincia());
		        rows.getCell(3).setCellStyle(style_cell);
		        
		        rows.createCell(4).setCellValue(emergencia.getDesDistrito());
		        ...
		        rows.createCell(6).setCellValue(emergencia.getPoblacionINEI());
		        rows.getCell(6).setCellStyle(style_cell);
		        
		        rows.createCell(7).setCellValue(emergencia.getFamAfectado());
		        rows.getCell(7).setCellStyle(style_cell);
		        
		        rows.createCell(8).setCellValue(emergencia.getFamDamnificado());
		        rows.getCell(8).setCellStyle(style_cell);
		        
		        rows.createCell(9).setCellValue(emergencia.getTotalFam());
		        rows.getCell(9).setCellStyle(style_cell);
		        
		        rows.createCell(10).setCellValue(emergencia.getPersoAfectado());
...
//		        rows.getCell(11).setCellStyle(style_cell);
		        ...
		        rows.createCell(11).setCellValue(emergencia.getPersoDamnificado());
		        rows.getCell(11).setCellStyle(style_cell);
		        
		        rows.createCell(12).setCellValue(emergencia.getTotalPerso());
		        ...
		        rows.createCell(15).setCellValue(emergencia.getTotalFamReal());
		        rows.getCell(15).setCellStyle(style_cell);
		        
		        rows.createCell(16).setCellValue(emergencia.getPersoAfectadoReal());
		        rows.getCell(16).setCellStyle(style_cell);
		       
		        rows.createCell(17).setCellValue(emergencia.getPersoDamnificadoReal());
		        rows.getCell(17).setCellStyle(style_cell);
		        
		        rows.createCell(18).setCellValue(emergencia.getTotalPersoReal());
