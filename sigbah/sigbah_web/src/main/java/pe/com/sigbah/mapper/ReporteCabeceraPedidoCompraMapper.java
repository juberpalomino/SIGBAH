 ...
 * @author: whr.
 */
public class ReporteCabeceraPedidoCompraMapper implements RowMapper<PedidoCompraReporteBean> {
	...
	public PedidoCompraReporteBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		pedido.setTipoPedido(rs.getInt("TIP_PEDIDO"));
		pedido.setMotivoCompra(rs.getString("MOTIVO_COMPRA"));
