...
$(document).ready(function() {
	...
	$('#btn_grabar').click(function(e) {
		...
		consultarAjax('POST', '/donaciones/stock-donacion/actualizarStockAlmacen', params, function(respuesta) {
	...
	$('.btn_retornar').click(function(e) {
		...
		loadding(true);					
		var url = VAR_CONTEXT + '/donaciones/stock-donacion/inicio/1';
...
function inicializarDatos() {
	...
	if (codigoRespuesta == NOTIFICACION_ERROR) {
		...
		$('#li_det_lotes').addClass('disabled');
