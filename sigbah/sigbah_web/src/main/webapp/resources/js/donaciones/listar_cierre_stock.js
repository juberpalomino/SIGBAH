...
$(document).ready(function() {
	...
	$('#btn_buscar').click(function(e) {
		...
		consultarAjax('GET', '/donaciones/cierre-stock/listarCierreStock', params, function(respuesta) {
	...
	$('#href_editar').click(function(e) {
		...
		if (indices.length == 0) {
			...
			loadding(true);
			var url = VAR_CONTEXT + '/donaciones/cierre-stock/mantenimientoCierreStock/';
...
function inicializarDatos() {
	...
	$('#li_reg_donaciones_cierre').closest('li').children('a').attr('href', '#');
