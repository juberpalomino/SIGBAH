...
//		}
	...
	$('#href_nuevo').click(function(e) {
		...
		if(indicador=="BAH_MAE_ALMACEN"){
			...
			$('#div_ddi').modal('show');
		}else if(indicador=="BAH_MAE_DISTRITO_INEI"){
			$('#h4_tit_poblacion_inei').html('Nuevo INEI');
			$('#txt_sub_archivo').val(null);
			$('#div_poblacion_inei').modal('show');
	...
	$('#btn_gra_per_inei').click(function(e) {
		...
		//if (bootstrapValidator.isValid()) {			
			...
			if (cod_ind_alfresco == '1' || cod_ind_alfresco == '2') { // Archivo cargado
				...
				consultarAjaxFile('POST', '/common/archivo/cargarArchivoExcel', formData, function(resArchivo) {
