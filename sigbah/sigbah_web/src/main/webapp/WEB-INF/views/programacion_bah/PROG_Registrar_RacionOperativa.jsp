				...
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<form id="frm_det_productos" class="form-horizontal" role="form">
							...
							<div class="row">
								<label class="col-sm-3 control-label">Unidad de presentacion (Kg.):</label>
								<div class="col-sm-3 form-group">
									<input type="text" id="txt_uni_pres" name="txt_uni_pres" class="form-control monto-format" >
								</div>

								<label class="col-sm-3 control-label">Gr. aprox.:</label>
								<div class="col-sm-3 form-group">
									<input type="text" name="txt_gr_aprox" id="txt_gr_aprox" class="form-control monto-format" >
								</div>
							</div>
