				...
				<div class="jarviswidget jarviswidget-color-blueLight">
					...
					<div>
						...
						<div class="widget-body">
							...
							<div id="div_tbl_almacen_externo" style="display: none;">
							...
							<div id="div_tbl_anio" style="display: none;">
							...
							<div id="div_tbl_categoria" style="display: none;">
							...
							<div id="div_tbl_chofer" style="display: none;">
							...
							<div id="div_tbl_ddi" style="display: none;">
							...
							<div id="div_tbl_distrito_inei" style="display: none;">
							...
							<div id="div_tbl_donante" style="display: none;">
							...
							<div id="div_tbl_empresa_transporte" style="display: none;">
							...
							<div id="div_tbl_envase" style="display: none;">
							...
							<div id="div_tbl_estado" style="display: none;">
							...
							<div id="div_tbl_medio_transporte" style="display: none;">
							...
							<div id="div_tbl_mod_almacen" style="display: none;">
							...
							<div id="div_tbl_moneda" style="display: none;">
							...
							<div id="div_tbl_motivo_traslado" style="display: none;">
							...
							<div id="div_tbl_oficina" style="display: none;">
							...
							<div id="div_tbl_pais" style="display: none;">
							...
							<div id="div_tbl_parametro" style="display: none;">
							...
							<div id="div_tbl_personal" style="display: none;">
							...
							<div id="div_tbl_personal_externo" style="display: none;">
							...
							<div id="div_tbl_region" style="display: none;">
							...
							<div id="div_tbl_tip_camion" style="display: none;">
							...
							<div id="div_tbl_tip_control_calidad" style="display: none;">
							...
							<div id="div_tbl_tip_documento" style="display: none;">
							...
							<div id="div_tbl_tip_movimiento" style="display: none;">
								<table id="tbl_tip_movimiento" class="table table-bordered table-hover tbl-responsive">
									<thead>			                
										<tr>
											...
											<th>Ingreso</th>
											<th>Salida</th>
											<th>Donación Ingreso</th>
											<th>Donación Salida</th>
											<th>Estado</th>
										</tr>
									</thead>
								</table>
							...
							<div id="div_tbl_unidad_medida" style="display: none;">
						...
						<form id="frm_nue_estado" class="form-horizontal" role="form">
							...
							<div class="form-group">																				
								...
								<div class="col-sm-3 form-group">
									<input type="text" name="txt_nom_almacen" id="txt_nom_almacen" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">																				
								...
								<div class="col-sm-3 form-group">
									<input type="text" name="txt_caracteristicas" id="txt_caracteristicas" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">																				
								...
								<div class="col-sm-3 form-group">
									<input type="text" name="txt_nombre_secundario" id="txt_nombre_secundario" class="form-control">
								</div>
							</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<form id="frm_nue_estado" class="form-horizontal" role="form">
							...
							<input type="hidden" id="hid_almacen_externo" name="hid_almacen_externo">
							...
							<div class="form-group">
								<div id="divRegiones">
									...
									<div id="div_gore_destino" class="row">
										...
										<div class="col-sm-3 form-group">
											<input type="text" name="txt_codigo_ext" id="txt_codigo_ext" class="form-control">
										</div>
									</div>
...
<script> var donaciones = JSON.parse('${general}'); </script>
<script src="${pageContext.request.contextPath}/resources/js/administracion/listar_tablas_generales.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/administracion/validacion_tablas_generales.js"></script>
