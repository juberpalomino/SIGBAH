...
<div id="ribbon">
	...
	<ol class="breadcrumb">
		...
		<li>Consulta de Tablas Generales</li>
	</ol>
	<!-- end breadcrumb -->
</div>
<!-- END RIBBON -->
...
<!-- Modal -->
<div id="div_poblacion_inei" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" id="btn_clo_documentos" class="close" data-dismiss="modal" aria-hidden="true">
				...
				<h4 class="modal-title label-bold1" id="h4_tit_poblacion_inei">Nuevo Documento</h4>
			</div>
