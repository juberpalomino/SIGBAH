			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget">
					<header>
						...
						<h2>Búsqueda de Guías de Remisión de Salida</h2>
					</header>
			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget jarviswidget-color-blueLight">
					...
					<header>
						...
						<h2>Relación de Guías de Remisión</h2>
...
<script src="${pageContext.request.contextPath}/resources/js/donaciones/listar_guia_donaciones.js"></script>
