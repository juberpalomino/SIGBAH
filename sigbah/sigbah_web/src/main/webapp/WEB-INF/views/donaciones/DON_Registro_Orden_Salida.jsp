									...
									<form id="frm_dat_generales" class="form-horizontal">
										...
										<div class="jarviswidget">
											<header>
												...
												<h2>Datos Generales de la Salida</h2>
											</header>
													...
													<div class="row">
														...
														<div class="col-sm-2 form-group">
															<select id="sel_tip_movimiento" name="sel_tip_movimiento" class="form-control">
																...
																<option value="1">Transferencia Entre Almacenes</option>
																<option value="2">Atención de Emergencias</option>
											...
											<div>
												...
												<div class="widget-body">
													...
													<div class="row">
														...
														<label class="col-sm-2 control-label">Almacen Destino:</label>
														<div class="col-sm-2 form-group">
															<select id="sel_alm_destino" name="sel_alm_destino" class="form-control">
															</select>
														</div>

														<label class="col-sm-2 control-label">Responsable Recepción:</label>
														<div class="col-sm-2 form-group">
...
<script src="${pageContext.request.contextPath}/resources/js/donaciones/mantenimiento_orden_salida.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/donaciones/validacion_mantenimiento_orden_salida.js"></script>
