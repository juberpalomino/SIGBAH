		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget">
					...
					<!-- widget div-->
					<div id="div_wid_bod_bus_cie_stock">
		
						<!-- widget content -->
						<div class="widget-body widget-body-50">
		
							<form id="frm_cie_stock" class="form-horizontal">
...
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/listar_cierre_stock.js"></script>
