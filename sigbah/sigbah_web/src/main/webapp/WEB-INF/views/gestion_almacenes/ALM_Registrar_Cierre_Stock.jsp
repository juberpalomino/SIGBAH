...
<div id="ribbon">
	...
	<ol class="breadcrumb">
		...
		<li>Stock</li>
		<li>Registro - Cartilla Mensual</li>
	</ol>
	<!-- end breadcrumb -->
</div>
<!-- END RIBBON -->
...
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/mantenimiento_cierre_stock.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/validacion_mantenimiento_cierre_stock.js"></script>
